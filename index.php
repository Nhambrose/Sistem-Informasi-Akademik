...
<html lang="en">
  <head>
	...
	<link rel="icon" href="assets/images/logopolines.png" type="image/ico" />

    <title> Sistem Informasi Akademik Polines </title>
    ...
    <div class="container body">
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-desktop"></i> Data Administrator <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.php?page=tambah_admin">Tambah Data</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-desktop"></i> Cetak <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="index.php?page=cetak_datamhs">Cetak Data Mahasiswa</a></li>
                      <li><a href="index.php?page=cetak_datadosen">Cetak Data Dosen</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
      ...
      switch ($queries['page']) {
        ...
        case 'edit_mhs_save':
          ...
          case 'cetak_datamhs':
        		# code...
        	include 'cetakmahasiswa.php';
        	break;

          case 'cetak_datadosen':
        		# code...
        	include 'cetakdosen.php';
        	break;
